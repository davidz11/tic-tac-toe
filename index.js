...
form.addEventListener("submit", (event) => {
  ...
  const player1Inputs = document.
  getElementById("player1")
  .value.trim()
  .toLowerCase();
  const player2Inputs = document.
  getElementById("player2")
  .value.trim()
  .toLowerCase();

  const player1InputCap  = 
  player1Inputs.charAt(0).toUpperCase() + player1Inputs.slice(1);
  const player2InputCap = 
  player2Inputs.charAt(0).toUpperCase() + player2Inputs.slice(1); 
